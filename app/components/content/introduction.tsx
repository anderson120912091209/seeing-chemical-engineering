            ...
            return (
              <div key={distribution.id} className="border border-white/10 rounded-lg overflow-hidden">
                <button
                  ...
                  className="w-full flex items-center gap-3 p-4 text-left hover:bg-white/5 transition-colors duration-200"
                >
                  ...
                  <span className="text-white/70 hover:text-white/90 transition-colors duration-200">
                    {distribution.name}
                  </span>
                </button>
                
                {isExpanded && (
                  <div className="px-4 pb-4 ml-7 space-y-3 animate-in slide-in-from-top duration-200">
                    <p className="text-white/60 text-sm leading-relaxed">
                      {distribution.explanation}
                    </p>
                    
                    <div className="space-y-1">
                      <h4 className="text-white/70 text-sm font-medium">Key Points:</h4>
