...
export default function Home() {
  return (
    <div className="h-screen bg-background text-foreground relative overflow-hidden">
      {/* Navigation Bar*/}
      <header className="fixed top-0 left-0 right-0 z-50 bg-background border-b border-muted-foreground/20">
        <NavigationBar />
      </header>
      ...
      <main className="relative z-20 h-screen pt-20">
        ...
        <div className="h-full grid grid-cols-12 grid-rows-8 gap-4 p-4">
          ...
          <div className="col-span-4 row-span-4 border-2 border-muted-foreground/30 hover:border-muted-foreground/50 transition-colors p-8 flex flex-col justify-center">
            <div className="space-y-6">
              ...
              <p className="text-base leading-relaxed text-muted-foreground/80">
                Transform complex engineering concepts into intuitive visual experiences through interactive mathematical modeling and dynamic simulation.
              </p>
              <p className="text-sm leading-relaxed text-muted-foreground/70">
                Our platform bridges the gap between abstract mathematical concepts and practical understanding through immersive visualizations designed specifically for chemical engineering education.
              </p>
          ...
          {/* Statistics Module */}
          <Link href="/advanced-statistics" className="col-span-4 row-span-2 group">
            <div className="h-full bg-muted-foreground/10 hover:bg-muted-foreground/20 transition-all duration-300 p-6 border-l-4 border-muted-foreground/50 hover:border-foreground group-hover:translate-x-1">
              <div className="h-full flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-black mb-3 group-hover:text-foreground transition-colors leading-tight">
                    ADVANCED<br />STATISTICS
                  </h3>
                  <p className="text-sm text-muted-foreground/70 group-hover:text-muted-foreground/90 transition-colors">
                    ANOVA • Regression • Statistical Inference
                  </p>
                </div>
                <div className="flex items-center justify-between mt-4">
                  ...
                  <div className="w-8 h-px bg-muted-foreground/30 group-hover:bg-foreground group-hover:w-12 transition-all"></div>
                </div>
              </div>
            </div>
          </Link>
          ...
          {/* Diffusion Module */}
          <Link href="/mass-diffusion" className="col-span-4 row-span-2 group">
            <div className="h-full bg-muted-foreground/10 hover:bg-muted-foreground/20 transition-all duration-300 p-6 border-l-4 border-muted-foreground/50 hover:border-foreground group-hover:translate-x-1">
              <div className="h-full flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground/70 group-hover:text-muted-foreground/90 transition-colors">
                    Transport • Molecular Motion • Fick's Laws
                  </p>
                </div>
                <div className="flex items-center justify-between mt-4">
                  <span className="text-xs font-mono text-muted-foreground/60 font-bold">
          ...
          {/* Thermo Module */}
          <Link href="/thermodynamics" className="col-span-4 row-span-2 group">
            <div className="h-full bg-muted-foreground/10 hover:bg-muted-foreground/20 transition-all duration-300 p-6 border-l-4 border-muted-foreground/50 hover:border-foreground group-hover:translate-x-1">
              <div className="h-full flex flex-col justify-between">
                <div>
                  <div className="text-xs font-mono text-muted-foreground/60 mb-3 tracking-widest">MODULE_03</div>
                  <h3 className="text-xl font-black mb-3 group-hover:text-foreground transition-colors leading-tight">
                    THERMO<br />DYNAMICS
                  </h3>
                  <p className="text-sm text-muted-foreground/70 group-hover:text-muted-foreground/90 transition-colors">
                    Energy Systems • Laws • Transformations
                  </p>
                </div>
                <div className="flex items-center justify-between mt-4">
                  <span className="text-xs font-mono text-muted-foreground/60 font-bold">
          ...
          <div className="col-span-6 row-span-1 bg-muted-foreground/5 hover:bg-muted-foreground/10 transition-colors p-4 flex items-center justify-between border border-muted-foreground/20">
            <div>
              ...
              <div className="text-sm font-bold text-muted-foreground/80">All Modules Online & Operational</div>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-muted-foreground/50 rounded-full"></div>
